...
func (UnimplementedPaymentServiceServer) ReplenishAccount(context.Context, *ReplenishAccountRequest) (*ReplenishAccountResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ReplenishAccount not implemented")
}
...
func (UnimplementedPaymentServiceServer) DebitToAccount(context.Context, *DebitToAccountRequest) (*DebitToAccountResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DebitToAccount not implemented")
}
